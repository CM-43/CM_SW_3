window.onload = function () {
  ...
  function loadColumnContentFromLocalStorage() {
    ...
    const site2Column = document.getElementById('site2-column');
    rejectColumn.innerHTML = localStorage.getItem('reject-column-content') || '';
    site2Column.innerHTML = localStorage.getItem('site2-column-content') || '';
