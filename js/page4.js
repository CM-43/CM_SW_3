...
fetch('site-1-step-2.json')
  ...
  .then(data => {
    ...
    const microbeData = JSON.parse(localStorage.getItem('site2Microbes')) || [];
  ...
  <div class="row">
    ...
    continueButton.addEventListener('click', () => {
      ...
      function saveColumnContentToLocalStorage() {
        ...
        const site2ColumnContent = document.getElementById('site2-column').innerHTML;

        localStorage.setItem('reject-column-content', rejectColumnContent);
        localStorage.setItem('site2-column-content', site2ColumnContent);
