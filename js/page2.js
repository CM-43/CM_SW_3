...
`;
  ...
  <div class="row">
    ...
    continueButton.addEventListener('click', () => {
      ...
      if (selectedSite.value === 'site2') { // Check if site2 is selected
        let site2Microbes = JSON.parse(localStorage.getItem('site2Microbes')) || []; // Retrieve or initialize
        site2Microbes.push(microbeData[currentMicrobeIndex]); // Add the selected microbe
        localStorage.setItem('site2Microbes', JSON.stringify(site2Microbes)); // Store updated data
      }
    ...
    // if (document.getElementById('submit-popup').style.display === 'block') {
    //   document.querySelector(".timer-text").innerHTML = "Time paused";
    //   clearInterval(x);
    // }
